          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              <h2 className="text-2xl font-semibold mb-6 flex items-center">
                <Building2 className="w-5 h-5 text-desert-400 mr-2" />
              ...
              <div className="space-y-6">
                {/* Business Name */}
                <div>
                  <label htmlFor="name" className="block text-sm font-medium text-desert-700 dark:text-desert-300 mb-1">
                    Business Name *
                  </label>
                  <input
                    type="text"
            ...
            <div>
              ...
              <div className="space-y-6">
                {/* Address */}
                <div>
                  <label htmlFor="address" className="block text-sm font-medium text-desert-700 dark:text-desert-300 mb-1">
          ...
          <div className="mt-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
              {Object.entries(formData.hours).map(([day, hours]) => (
                <div key={day}>
                  <label htmlFor={`hours-${day}`} className="block text-sm font-medium text-desert-700 dark:text-desert-300 mb-1">
                    {day}
                  </label>
                  <input
                    type="text"
